...
if choice==1:
      ...
      while name=='alwin' and passwd=='alwin123' :
            print('welcome')
            ...
            print('5.registry for cancellation of order')
            ...
            if choice==1:
                  ...
                  products_available=input('Number of stocks available:')
                 ...
                 sql_insert="insert into order_details values(""'"+customer_name+"'," "'"+mobile_number+"'," "'"+address+"'," "'"+date_to_deliver+"'"")"
                 c1.execute(sql_insert)
                 conn.commit()
                 print('SUCCESSFULLY REGISTERED')
                 ...
                 reason_for_cancellation=input('enter the reason for cancelling the order:')
                 confirm_cancellation=input('say YES or NO:')
                 while confirm_cancellation=='yes':
                       sql_insert="insert into cancellation_of_order values(""'"+customer_name+"'," "'"+order_number+"'," "'"+products_contained+"'," "'"+reason_for_cancellation+"',""'"+confirm_cancellation+"'"")"
                       c1.execute(sql_insert)
                       conn.commit()
